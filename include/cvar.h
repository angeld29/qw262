...
#define CVAR_USERINFO		0x0002		// mirrored to userinfo
#define CVAR_SERVERINFO		0x0004		// mirrored to serverinfo
#ifdef SERVERONLY
...
// creates variable and link it to lists
