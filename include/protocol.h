...
// BorisU -->
#define	OLD_PROTOCOL_VERSION	28
// <-- BorisU
...
#define	svc_checkcmd		15		// [string]	 - name
...
#define svc_nails2			54		// for interpolation, stores edict num (highlander)
//==============================================
...
#define	MVD_MAX_PACKET_ENTITIES		300	// doesn't count nails (Highlander)
										// increased from 196 to 300 by BorisU
										// 196 is too small for some TF maps
										// that have a lot of entities
