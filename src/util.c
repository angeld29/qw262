...
{
	if (!Q_stricmp(team, Utils_TF_ColorToTeam(13)))
		return 13;
	if (!Q_stricmp(team, Utils_TF_ColorToTeam(4)))
		return 4;
	if (!Q_stricmp(team, Utils_TF_ColorToTeam(12)))
		return 12;
	if (!Q_stricmp(team, Utils_TF_ColorToTeam(11)))
		return 11;
	return 0;
}
